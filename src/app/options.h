...
private:
    QFont _font;
    int _tab_width;
    ProxyMode _proxy_mode;
    QString _proxy_host;
    quint16 _proxy_port;
    QString _proxy_user;
    QString _proxy_password;
    bool _autolink_enabled;
    bool _strikethrough_enabled;
    bool _alphabetic_lists_enabled;
    bool _definition_lists_enabled;
    bool _smarty_pants_enabled;
    bool _footnotes_enabled;
    bool _superscript_enabled;
    bool _math_support_enabled;
    bool _math_inline_support_enabled;
    bool _code_highlighting_enabled;
    bool _show_special_characters_enabled;
    bool _word_wrap_enabled;
    bool _source_at_single_size_enabled;
    bool _spelling_check_enabled;
    bool _yaml_header_support_enabled;
    bool _diagram_support_enabled;
    bool _line_column_enabled;
    bool _ruler_enabled;
    int _ruler_pos;
    QString _dictionary_language;
    MarkdownConverter _markdown_converter;
    QString _last_used_theme;
    QString _standard_font_family;
    QString _fixed_font_family;
    QString _serif_font_family;
    QString _sans_serif_font_family;
    int _default_font_size;
    int _default_fixed_font_size;
    QMap<QString, QKeySequence> _custom_shortcuts;
};
